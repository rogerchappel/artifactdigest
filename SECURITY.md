...
Replace this section with the supported versions for `artifactdigest`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `artifactdigest` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in artifactdigest.
